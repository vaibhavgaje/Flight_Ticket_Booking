...
export default class Economy extends Component {
  ...
  render() {
    const rows = [
      ...
      [
        { id: 21, number: 21, isSelected: this.state.props, isReserved: false },
        { id: 22, number: 22, isSelected: this.state.props, isReserved: false },
        null,
        { id: 23, number: 23, isSelected: this.state.props, isReserved: false },
        { id: 24, number: 24, isSelected: this.state.props, isReserved: false },

        { id: 25, number: 25, isSelected: this.state.props, isReserved: false }
      ],
      [
        { id: 26, number: 26, isSelected: this.state.props, isReserved: false },
        { id: 27, number: 27, isSelected: this.state.props, isReserved: false },
        null,
        { id: 28, number: 28, isSelected: this.state.props, isReserved: false },
        { id: 29, number: 29, isSelected: this.state.props, isReserved: false },

        { id: 30, number: 30, isSelected: this.state.props, isReserved: false }
      ],
    ];
    ...
    return (
      ...
      <div className="container">
        ...
        <div style={{ marginTop: "100px" }}>
          ...
          {/* <div>
          <button onClick={handleSubmit}><h2>
